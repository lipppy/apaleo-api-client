...
class BulkMoveItemRequest(BaseModel):
    ...
    source_folio_id: str = Field(..., alias="sourceFolioId", description="ID of the source folio")
    target_folio_id: str = Field(..., alias="targetFolioId", description="ID of the target folio")
...
class BulkMoveRequest(BaseModel):
    ...
    items: list[BulkMoveItemRequest] = Field(..., description="The list of actions to perform")
    reason: str = Field(..., description="Description of why the move is performed", min_length=1)
...
class EmbeddedPropertyModel(BaseModel):
    ...
    description: str | None = Field(None, description="The description for the property")
...
class PaymentModel(BaseModel):
    ...
    id: str = Field(..., description="Id of the payment. This is unique within one folio.")
    method: Method2 = Field(..., description="The Payment Method.")
    amount: MonetaryValueModel
    external_reference: ExternalReference | None = Field(None, alias="externalReference")
...
class PaymentPaidChargesRequest(BaseModel):
    ...
    charge_id: str = Field(..., alias="chargeId", description="The ID of the charge being paid")
    amount: float = Field(
        ...,
...
class StayInfoModel(BaseModel):
    ...
    room_number: str | None = Field(None, alias="roomNumber", description="The last room number")
...
class TaxAmountModel(BaseModel):
    ...
    percent: float = Field(..., description="The currently valid percent to calculate the VAT")
...
class TransitoryChargeModel(BaseModel):
    ...
    id: str = Field(..., description="ID for transitory charge. This is unique within one folio.")
    name: str = Field(
        ...,
...
class Code(StrEnum):
    ...
    cancel_not_allowed_for_incomplete_payment_link = "CancelNotAllowedForIncompletePaymentLink"
...
class AllowanceModel(BaseModel):
    ...
    id: str = Field(..., description="ID for allowances. This is unique within one folio.")
    amount: AmountModel
    reason: str = Field(..., description="Reason why this allowance was posted", min_length=1)
    service_type: ServiceType = Field(..., alias="serviceType")
    service_date: date_aliased = Field(..., alias="serviceDate", examples=["2020-10-10"])
    created: AwareDatetime = Field(
        ...,
        description='Date of creation<br />A date and time (without fractional second part) in UTC or with UTC offset as defined in <a href="https://en.wikipedia.org/wiki/ISO_8601">ISO8601:2004</a>',
    )
...
class ChargeModel(BaseModel):
    ...
    is_posted: bool = Field(..., alias="isPosted", description="Status: is this already posted?")
    service_date: date_aliased = Field(
        ...,
        alias="serviceDate",
...
class CompanyInfoModel(BaseModel):
    ...
    tax_id: str | None = Field(None, alias="taxId", description="Tax or Vat ID of the company")
...
class CreateAllowanceBulkModel(BaseModel):
    ...
    reason: str = Field(..., description="Description of why allowances are added", min_length=1)
...
class CreateAllowanceForChargeModel(BaseModel):
    ...
    reason: str = Field(..., description="Reason why this allowance is posted", min_length=1)
    amount: MonetaryValueModel
    business_date: date_aliased | None = Field(
        None,
        alias="businessDate",
...
class CreateFolioRefundRequest(BaseModel):
    ...
    method: Method = Field(..., description="The payment method the refund will be accounted to")
    amount: MonetaryValueModel
...
class ExportGrossTransactionItemModel(BaseModel):
    ...
    net_amount: float = Field(..., alias="netAmount", description="The net amount being booked")
...
class FolioItemModel(BaseModel):
    ...
    allowances: list[AllowanceModel] | None = Field(None, description="The list of allowances")
    ...
    payments: list[PaymentModel] | None = Field(None, description="The list of payments")
...
class IncludedLineItemModel(BaseModel):
    ...
    description: str | None = Field(None, description="The description of the item or service")
    price: MonetaryValueModel
    vat_type: VatType | None = Field(None, alias="vatType", description="The applied VAT type.")
...
class InvoiceItemModel(BaseModel):
    ...
    folio_id: str = Field(..., alias="folioId", description="The folio for this invoice")
    ...
    property_id: str = Field(..., alias="propertyId", description="The ID of the property")
    ...
    outstanding_payment: MonetaryValueModel | None = Field(None, alias="outstandingPayment")
    ...
    guest_name: str | None = Field(None, alias="guestName", description="Name of the guest")
...
class PreviewInvoiceModel(BaseModel):
    ...
    commercial_information: CommercialInfoModel = Field(..., alias="commercialInformation")
    ...
    payments: list[InvoicePaymentModel] | None = Field(None, description="A list of all payments")
    outstanding_payment: MonetaryValueModel | None = Field(None, alias="outstandingPayment")
