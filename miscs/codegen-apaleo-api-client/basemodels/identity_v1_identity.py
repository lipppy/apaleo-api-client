...
class CreateInvitationModel(BaseModel):
    ...
    email: EmailStr = Field(..., description="Email address, used as the login", min_length=1)
...
class InvitationModel(BaseModel):
    ...
    email: str = Field(..., description="Email address, used as the login", min_length=1)
    properties: list[str] | None = Field(None, description="Properties that user has access to")
...
class UserItemModel(BaseModel):
    ...
    subject_id: UUID = Field(..., alias="subjectId", description="Unique user identifier.")
    first_name: str = Field(..., alias="firstName", description="First name", min_length=1)
